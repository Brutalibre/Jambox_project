...
public class ArduinoUsbService extends IntentService {
    ...
    /*
    		...
    		for (int ii=0; ii<ret; ii++) {
    			buffer2.append(byte.toString(buffer[ii]) + " " );
    		}
...
/*
            ...
            String txt = "Ta gueule";
            sendMessageToClients(txt);
...
*/
    ...
    public void sendMessageToServer(String message) {
        try {
            Message msg = Message.obtain(null,
                    ArduinoUsbService.MSG_SEND_ASCII_TO_SERVER, message);
            Bundle b = new Bundle();
            b.putCharSequence(ArduinoUsbService.MSG_KEY, message);
            msg.setData(b);
            msg.replyTo = mMessenger_;
    ...
    public void sendBytesToServer(byte[] data) {
        try {
            Message msg = Message.obtain(null,
                    ArduinoUsbService.MSG_SEND_BYTES_TO_SERVER);
            Bundle b = new Bundle();
            b.putByteArray(ArduinoUsbService.MSG_KEY, data);
            msg.setData(b);
            msg.replyTo = mMessenger_;
