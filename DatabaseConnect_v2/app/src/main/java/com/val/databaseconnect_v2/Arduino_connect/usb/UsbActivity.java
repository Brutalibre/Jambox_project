...
//                    Log.e(TAG, "Client handleMessage Exception: "+ Utils.getExceptionStack(ee, true));
    ...
    public void onConnectMenu() {
        ...
        Intent stopServiceIntent = new Intent(this, com.val.databaseconnect_v2.Arduino_connect.usb.ArduinoUsbService.class);
        this.stopService(stopServiceIntent);

        SystemClock.sleep(1500);

        Intent startServiceIntent = new Intent(this, com.val.databaseconnect_v2.Arduino_connect.usb.ArduinoUsbService.class);
